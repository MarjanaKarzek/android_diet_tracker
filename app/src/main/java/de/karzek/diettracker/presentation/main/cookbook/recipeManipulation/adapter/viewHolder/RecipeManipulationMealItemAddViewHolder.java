 ...
 * @date 30.05.2018
 */
public class RecipeManipulationMealItemAddViewHolder extends RecyclerView.ViewHolder {

    @BindView(R.id.recipe_image) ImageView imageView;

    private final OnDeleteImageClickListener onDeleteImageClickListener;

    public RecipeManipulationMealItemAddViewHolder(ViewGroup viewGroup,
