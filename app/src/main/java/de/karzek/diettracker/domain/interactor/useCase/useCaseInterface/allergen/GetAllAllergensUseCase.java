 ...
 * @date 27.05.2018
 */
public interface GetAllAllergensUseCase extends BaseObservableUseCase<GetAllAllergensUseCase.Input, GetAllAllergensUseCase.Output> {
    ...
    class Output implements BaseUseCase.Output {
        ...
        List<AllergenDomainModel> allergens;
        ...
        private @interface AllergenListStatus {
