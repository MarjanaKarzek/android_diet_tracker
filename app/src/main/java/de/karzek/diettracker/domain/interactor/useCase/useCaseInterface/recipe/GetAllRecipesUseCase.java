 ...
 * @date 27.05.2018
 */
public interface GetAllRecipesUseCase extends BaseObservableUseCase<GetAllRecipesUseCase.Input, GetAllRecipesUseCase.Output> {
    ...
    class Output implements BaseUseCase.Output {
        ...
        private @interface RecipeDataListStatus {
